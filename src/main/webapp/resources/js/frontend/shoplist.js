$(function () {
    ...
    var pageSize = 3;
    // 获取店铺列表的URL
    var listUrl = '/o2omaven/frontend/listshops';
    // 获取店铺类别列表以及区域列表的URL
    var searchDivUrl = '/o2omaven/frontend/listshopspageinfo';
    // 页码
    var pageNum = 1;
    ...
    function getSearchDivData() {
        ...
        $.getJSON(url, function (data) {
            if (data.success) {
                ...
                areaList.map(function (index, domElement) {
                    selectOptions += '<option value="' + index.areaId + '">' + index.areaName + '</option>';
                });
                // 将标签集添加进area列表里
