...
public class ShopListController {
    ...
    /*
     * @Description 返回商品列表页里的ShopCategory列表(二级或者一级)，以及区域信息列表
     * @Param [request]
    ...
    /*
     * @Description 组合查询条件，并将条件封装到ShopCondition对象里返回
     * @Param [parentId, shopCategoryId, areaId, shopName]
